...
'+"\\"></body>"',style:"display:none"}),(9==a.nodeType?a:a.ownerDocument||a.document).body.appendChild(a))):e?Be(a,b,"POST",e,d):Q("USE_NET_AJAX_FOR_PING_TRANSPORT",!1)||d?Be(a,b,"GET","",d):Ke(a,b)||Le(a,b))}
function Ke(a,b){var c=Yd.EXPERIMENT_FLAGS;if(!c||!c.web_use_beacon_api_for_ad_click_server_pings)return!1;c=K(L(5,a));return c&&-1!=c.indexOf("/aclk")&&"1"===nc(a,"ae")&&"1"===nc(a,"act")?Me(a)?(b&&b(),!0):!1:!1}
...
window.console.log(c.join("\n"),e)),e=a.stacktrace,c=a.columnNumber,a.hasOwnProperty("params")&&(d=String(JSON.stringify(a.params)),f.params=d.substr(0,500)),a=Vb(a),e=e||a.stack,d=a.lineNumber.toString(),isNaN(d)||isNaN(c)||(d=d+":"+c),window.yterr&&Ba(window.yterr)&&window.yterr(a),Ne[a.message]||0<=e.indexOf("/YouTubeCenter.js")||0<=e.indexOf("/mytube.js")))){b={Ya:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,250),line:d,level:b,"client.name":f.name},D:{url:Q("PAGE_NAME",window.location.href),
file:a.fileName},method:"POST"};f.version&&(b["client.version"]=f.version);e&&(b.D.stack=e);for(var g in f)b.D["client."+g]=f[g];if(g=Q("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(var h in g)b.D[h]=g[h];Ae(Q("ECATCHER_REPORT_HOST","")+"/error_204",b);Ne[a.message]=!0;Oe++}}
;var Qe=window.yt&&window.yt.msgs_||window.ytcfg&&window.ytcfg.msgs||{};z("yt.msgs_",Qe,void 0);function Re(a){Xd(Qe,arguments)}
...
;var We=A("ytPubsubPubsubInstance")||new O;O.prototype.subscribe=O.prototype.subscribe;O.prototype.unsubscribeByKey=O.prototype.M;O.prototype.publish=O.prototype.L;O.prototype.clear=O.prototype.clear;z("ytPubsubPubsubInstance",We,void 0);var Xe=A("ytPubsubPubsubSubscribedKeys")||{};z("ytPubsubPubsubSubscribedKeys",Xe,void 0);var Ye=A("ytPubsubPubsubTopicToKeys")||{};z("ytPubsubPubsubTopicToKeys",Ye,void 0);var Ze=A("ytPubsubPubsubIsSynchronous")||{};z("ytPubsubPubsubIsSynchronous",Ze,void 0);
...
function bf(a){var b=af();b&&("number"==typeof a?a=[a]:y(a)&&(a=[parseInt(a,10)]),H(a,function(c){b.unsubscribeByKey(c);delete Xe[c]}))}
...
function af(){return A("ytPubsubPubsubInstance")}
function ef(a){Ye[a]&&(a=Ye[a],H(a,function(b){Xe[b]&&delete Xe[b]}),a.length=0)}
...
function jf(a,b,c){c=void 0===c?null:c;var d=kf(a),e=document.getElementById(d),f=e&&Ue(e,"loaded"),g=e&&!f;f?b&&b():(b&&(f=$e(d,b),b=""+(b[Da]||(b[Da]=++Ea)),lf[b]=f),g||(e=mf(a,d,function(){Ue(e,"loaded")||(Se(e),cf(d),T(Ha(df,d),0))},c)))}
...
function of(a,b){if(a&&b){var c=""+(b[Da]||(b[Da]=++Ea));(c=lf[c])&&bf(c)}}
function kf(a){var b=document.createElement("a");Hb(b,a);a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+Mb(a)}
var lf={};function pf(){}
function qf(a,b){return rf(a,1,b)}
;function sf(){}
t(sf,pf);function rf(a,b,c){isNaN(c)&&(c=void 0);var d=A("yt.scheduler.instance.addJob");return d?d(a,b,c):void 0===c?(a(),NaN):T(a,c||0)}
function tf(a){if(!isNaN(a)){var b=A("yt.scheduler.instance.cancelJob");b?b(a):U(a)}}
sf.prototype.start=function(){var a=A("yt.scheduler.instance.start");a&&a()};
sf.prototype.pause=function(){var a=A("yt.scheduler.instance.pause");a&&a()};
xa(sf);sf.getInstance();var uf=[],vf=!1;function wf(){if("1"!=Ua($d(),"args","privembed")){var a=function(){vf=!0;"google_ad_status"in window?P("DCLKSTAT",1):P("DCLKSTAT",2)};
...
yf.prototype.dispose=function(){this.f=null};var Af=window,Bf=Af.ytcsi&&Af.ytcsi.now?Af.ytcsi.now:Af.performance&&Af.performance.timing&&Af.performance.now?function(){return Af.performance.timing.navigationStart+Af.performance.now()}:function(){return(new Date).getTime()};var Cf=new yf,Df=!1,Ef=0,Ff="";function Gf(a){S("botguard_periodic_refresh")?Ef=Bf():S("botguard_always_refresh")&&(Ff=a)}
function Hf(a){if(a){if(Cf.g)return!1;if(S("botguard_periodic_refresh"))return 72E5<Bf()-Ef;if(S("botguard_always_refresh"))return Ff!=a}else return!1;return!Df}
function If(){return!!Cf.f}
function Jf(a){a=void 0===a?{}:a;a=void 0===a?{}:a;return Cf.f?Cf.f.invoke(void 0,void 0,a):null}
;var Kf=0;z("ytDomDomGetNextId",A("ytDomDomGetNextId")||function(){return++Kf},void 0);var Lf={stopImmediatePropagation:1,stopPropagation:1,preventMouseEvent:1,preventManipulation:1,preventDefault:1,layerX:1,layerY:1,screenX:1,screenY:1,scale:1,rotation:1,webkitMovementX:1,webkitMovementY:1};
...
Mf.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var Wa=A("ytEventsEventsListeners")||{};z("ytEventsEventsListeners",Wa,void 0);var Of=A("ytEventsEventsCounter")||{count:0};z("ytEventsEventsCounter",Of,void 0);
...
g=de(g);a.addEventListener?("mouseenter"==b&&f?b="mouseover":"mouseleave"==b&&f?b="mouseout":"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"),Qf()||"boolean"==typeof d?a.addEventListener(b,g,d):a.addEventListener(b,g,!!d.capture)):a.attachEvent("on"+b,g);Wa[e]=[a,b,c,g,d];return e}
function Rf(a){a&&("string"==typeof a&&(a=[a]),H(a,function(b){if(b in Wa){var c=Wa[b],d=c[0],e=c[1],f=c[3];c=c[4];d.removeEventListener?Qf()||"boolean"==typeof c?d.removeEventListener(e,f,c):d.removeEventListener(e,f,!!c.capture):d.detachEvent&&d.detachEvent("on"+e,f);delete Wa[b]}}))}
...
E(Tf,M);Tf.prototype.G=function(a){x(a.f)||Nf(a);var b=a.f;x(a.g)||Nf(a);this.f=new Yb(b,a.g)};
...
function Vf(a){var b=void 0===a?{}:a;a=void 0===b.za?!0:b.za;b=void 0===b.Na?!1:b.Na;if(null==A("_lact",window)){var c=parseInt(Q("LACT"),10);c=isFinite(c)?D()-Math.max(c,0):-1;z("_lact",c,window);z("_fact",c,window);-1==c&&Wf();V(document,"keydown",Wf);V(document,"keyup",Wf);V(document,"mousedown",Wf);V(document,"mouseup",Wf);a&&(b?V(window,"touchmove",function(){Xf("touchmove",200)},{passive:!0}):(V(window,"resize",function(){Xf("resize",200)}),V(window,"scroll",function(){Xf("scroll",200)})));
new Tf(function(){Xf("mouse",100)});
V(document,"touchstart",Wf,{passive:!0});V(document,"touchend",Wf,{passive:!0})}}
function Xf(a,b){Uf[a]||(Uf[a]=!0,qf(function(){Wf();Uf[a]=!1},b))}
function Wf(){null==A("_lact",window)&&Vf();var a=D();z("_lact",a,window);-1==A("_fact",window)&&z("_fact",a,window);(a=A("ytglobal.ytUtilActivityCallback_"))&&a()}
function Yf(){var a=A("_lact",window);return null==a?-1:Math.max(D()-a,0)}
;var Zf=Math.pow(2,16)-1,$f=null,ag=0,bg={log_event:"events",log_interaction:"interactions"},cg=Object.create(null);cg.log_event="GENERIC_EVENT_LOGGING";cg.log_interaction="INTERACTION_LOGGING";var dg=new Set(["log_event"]),eg={},fg=0,gg=0,W=A("ytLoggingTransportLogPayloadsQueue_")||{};z("ytLoggingTransportLogPayloadsQueue_",W,void 0);var hg=A("ytLoggingTransportTokensToCttTargetIds_")||{};z("ytLoggingTransportTokensToCttTargetIds_",hg,void 0);var ig=A("ytLoggingTransportDispatchedStats_")||{};
z("ytLoggingTransportDispatchedStats_",ig,void 0);z("ytytLoggingTransportCapturedTime_",A("ytLoggingTransportCapturedTime_")||{},void 0);function jg(){U(fg);U(gg);gg=0;if(!Xa(W)){for(var a in W){var b=eg[a];b&&(kg(a,b),delete W[a])}Xa(W)||lg()}}
function lg(){S("web_gel_timeout_cap")&&!gg&&(gg=T(jg,6E4));U(fg);fg=T(jg,Q("LOGGING_BATCH_TIMEOUT",ne("web_gel_debounce_ms",1E4)))}
function mg(a,b){b=void 0===b?"":b;W[a]=W[a]||{};W[a][b]=W[a][b]||[];return W[a][b]}
function kg(a,b){var c=bg[a],d=ig[a]||{};ig[a]=d;var e=Math.round(Bf());for(l in W[a]){var f=ab,g=b.f;g={client:{hl:g.Ga,gl:g.Fa,clientName:g.Da,clientVersion:g.Ea,configInfo:g.Ca}};var h=window.devicePixelRatio;h&&1!=h&&(g.client.screenDensityFloat=String(h));Q("DELEGATED_SESSION_ID")&&!S("pageid_as_header_web")&&(g.user={onBehalfOfUser:Q("DELEGATED_SESSION_ID")});f=f({context:g});f[c]=mg(a,l);d.dispatchedEventCount=d.dispatchedEventCount||0;d.dispatchedEventCount+=f[c].length;if(g=hg[l])a:{var k=
l;if(g.videoId)h="VIDEO";else if(g.playlistId)h="PLAYLIST";else break a;f.credentialTransferTokenTargetId=g;f.context=f.context||{};f.context.user=f.context.user||{};f.context.user.credentialTransferTokens=[{token:k,scope:h}]}delete hg[l];f.requestTimeMs=e;if(g=Zd("EVENT_ID"))h=(Q("BATCH_CLIENT_COUNTER",void 0)||0)+1,h>Zf&&(h=1),P("BATCH_CLIENT_COUNTER",h),g={serializedEventId:g,clientCounter:h},f.serializedClientEventId=g,$f&&ag&&S("log_gel_rtt_web")&&(f.previousBatchInfo={serializedClientEventId:$f,
roundtripMs:ag}),$f=g,ag=0;ng(b,a,f,{retry:dg.has(a),onSuccess:B(og,this,Bf())})}if(d.previousDispatchMs){c=e-d.previousDispatchMs;var l=d.diffCount||0;d.averageTimeBetweenDispatchesMs=l?(d.averageTimeBetweenDispatchesMs*l+c)/(l+1):c;d.diffCount=l+1}d.previousDispatchMs=e}
function og(a){ag=Math.round(Bf()-a)}
;var pg=A("ytLoggingGelSequenceIdObj_")||{};z("ytLoggingGelSequenceIdObj_",pg,void 0);
function qg(a,b,c,d){d=void 0===d?{}:d;var e={};e.eventTimeMs=Math.round(d.timestamp||Bf());e[a]=b;e.context={lastActivityMs:String(d.timestamp?-1:Yf())};S("log_sequence_info_on_gel_web")&&d.O&&(a=e.context,b=d.O,pg[b]=b in pg?pg[b]+1:0,a.sequence={index:pg[b],groupKey:b},d.pb&&delete pg[d.O]);(d=d.aa)?(a={},d.videoId?a.videoId=d.videoId:d.playlistId&&(a.playlistId=d.playlistId),hg[d.token]=a,d=mg("log_event",d.token)):d=mg("log_event");d.push(e);c&&(eg.log_event=new c);d.length>=(ne("web_logging_max_batch")||
100)?jg():lg()}
...
var tg=1;function ug(a,b,c){var d=vg;b={csn:a,parentVe:sg(b),childVes:La(c,function(f){return sg(f)})};
c=q(c);for(var e=c.next();!e.done;e=c.next())e=sg(e.value),(Xa(e)||!e.trackingParams&&!e.veType)&&Pe(Error("Child VE logged with no data"),"WARNING");c={aa:void 0,O:a};"UNDEFINED_CSN"==a?wg("visualElementAttached",b,c):qg("visualElementAttached",b,d,c)}
function wg(a,b,c){a={sb:a,payload:b,options:c};(b=Q("INTERACTIONS_LOGGER_QUEUE",void 0))?b.push(a):P("INTERACTIONS_LOGGER_QUEUE",[a])}
;function xg(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||Q("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.mb||Q("AUTHORIZATION"))||(a?b="Bearer "+A("gapi.auth.getToken")().lb:b=Ac([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=Q("SESSION_INDEX",0),S("pageid_as_header_web")&&(d["X-Goog-PageId"]=Q("DELEGATED_SESSION_ID")));return d}
...
;function zg(a,b,c,d){Ub.set(""+a,b,c,"/",void 0===d?"youtube.com":d,!1)}
;function Ag(){var a=new Od;(a=a.isAvailable()?new Ud(a,"yt.innertube"):null)||(a=new Pd("yt.innertube"),a=a.isAvailable()?a:null);this.f=a?new Kd(a):null;this.g=document.domain||window.location.hostname}
Ag.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.f)try{this.f.set(a,b,D()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(gd(b))}catch(f){return}else e=escape(b);zg(a,e,c,this.g)};
Ag.prototype.get=function(a,b){var c=void 0,d=!this.f;if(!d)try{c=this.f.get(a)}catch(e){d=!0}if(d&&(c=Ub.get(""+a,void 0))&&(c=unescape(c),b))try{c=JSON.parse(c)}catch(e){this.remove(a),c=void 0}return c};
Ag.prototype.remove=function(a){this.f&&this.f.remove(a);var b=this.g;Ub.remove(""+a,"/",void 0===b?"youtube.com":b)};var Bg=new Ag;function Cg(a,b,c,d){if(d)return null;d=Bg.get("nextId",!0)||1;var e=Bg.get("requests",!0)||{};e[d]={method:a,request:b,authState:yg(c),requestTime:Math.round(Sf())};Bg.set("nextId",d+1,86400,!0);Bg.set("requests",e,86400,!0);return d}
function Dg(a){var b=Bg.get("requests",!0)||{};delete b[a];Bg.set("requests",b,86400,!0)}
function Eg(a){var b=Bg.get("requests",!0);if(b){for(var c in b){var d=b[c];if(!(6E4>Math.round(Sf())-d.requestTime)){var e=d.authState,f=yg(xg(!1));Za(e,f)&&(e=d.request,"requestTimeMs"in e&&(e.requestTimeMs=Math.round(Sf())),ng(a,d.method,e,{}));delete b[c]}}Bg.set("requests",b,86400,!0)}}
...
function ng(a,b,c,d){!Q("VISITOR_DATA")&&.01>Math.random()&&R(Error("Missing VISITOR_DATA when sending innertube request."),"WARNING");var e={headers:{"Content-Type":"application/json"},method:"POST",D:c,la:"JSON",N:function(){d.N()},
...
timeout:d.timeout,withCredentials:!0},f="",g=a.f.Ha;g&&(f=g);g=a.f.Ia||!1;var h=xg(g,f,d);Object.assign(e.headers,h);e.headers.Authorization&&!f&&(e.headers["x-origin"]=window.location.origin);var k=he(""+f+("/youtubei/"+a.f.Ba+"/"+b),{alt:"json",key:a.f.Aa}),l;if(d.retry&&S("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=f&&(l=Cg(b,c,h,g))){var n=e.onSuccess,r=e.ja;e.onSuccess=function(v,p){Dg(l);n(v,p)};
c.ja=function(v,p){Dg(l);r(v,p)}}try{S("use_fetch_for_op_xhr")?xe(k,e):Ge(k,e)}catch(v){if("InvalidAccessError"==v)l&&(Dg(l),l=0),R(Error("An extension is blocking network request."),"WARNING");
else throw v;}l&&rf(function(){Eg(a)},0,5E3)}
;var Fg=D().toString();
function Gg(){a:{if(window.crypto&&window.crypto.getRandomValues)try{var a=Array(16),b=new Uint8Array(16);window.crypto.getRandomValues(b);for(var c=0;c<a.length;c++)a[c]=b[c];var d=a;break a}catch(e){}d=Array(16);for(a=0;16>a;a++){b=D();for(c=0;c<b%23;c++)d[a]=Math.random();d[a]=Math.floor(256*Math.random())}if(Fg)for(a=1,b=0;b<Fg.length;b++)d[a%16]=d[a%16]^d[(a-1)%16]/4^Fg.charCodeAt(b),a++}a=[];for(b=0;b<d.length;b++)a.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(d[b]&63));
return a.join("")}
;var Hg=A("ytLoggingTimeDocumentNonce_")||Gg();z("ytLoggingTimeDocumentNonce_",Hg,void 0);function Ig(a){a=void 0===a?0:a;return 0==a?"client-screen-nonce":"client-screen-nonce."+a}
function Jg(a){a=void 0===a?0:a;return 0==a?"ROOT_VE_TYPE":"ROOT_VE_TYPE."+a}
function Kg(a){return Q(Jg(void 0===a?0:a),void 0)}
z("yt_logging_screen.getRootVeType",Kg,void 0);function Lg(){var a=Kg(0),b;a?b=new rg({veType:a,youtubeData:void 0}):b=null;return b}
function Mg(a){a=void 0===a?0:a;var b=Q(Ig(a));b||0!=a||(S("kevlar_client_side_screens")?b="UNDEFINED_CSN":b=Q("EVENT_ID"));return b?b:null}
z("yt_logging_screen.getCurrentCsn",Mg,void 0);function Ng(a,b,c){c=void 0===c?0:c;if(a!==Q(Ig(c))||b!==Q(Jg(c)))P(Ig(c),a),P(Jg(c),b),0==c&&(b=function(){setTimeout(function(){a&&qg("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:Hg,clientScreenNonce:a},vg)},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b())}
z("yt_logging_screen.setCurrentScreen",Ng,void 0);function Og(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=Q("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=Q("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=K(L(3,window.location.href));g&&f.push(g);g=K(L(3,d));if(0<=Ja(f,g)||!g&&0==d.lastIndexOf("/",0))if(S("autoescape_tempdata_url")&&(f=document.createElement("a"),Hb(f,d),d=f.href),d){g=d.match(ic);d=g[5];f=g[6];g=g[7];var h="";d&&(h+=d);f&&(h+="?"+f);g&&(h+="#"+g);d=h;f=d.indexOf("#");if(d=0>f?d:d.substr(0,f))if(e&&(b.itct||b.ved)&&
(b.csn=b.csn||Mg()),k){var k=parseInt(k,10);isFinite(k)&&0<k&&(e="ST-"+Mb(d).toString(36),b=b?kc(b):"",zg(e,b,k||5))}else k="ST-"+Mb(d).toString(36),b=b?kc(b):"",zg(k,b,5)}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var l=void 0===l?{}:l;var n=void 0===n?"":n;var r=void 0===r?window:r;c=r.location;a=lc(a,l)+n;a=a instanceof I?a:xb(a);c.href=vb(a)}return!0}
;function Pg(a){a=a||{};var b={enablejsapi:1},c={};this.url=a.url||"";this.args=a.args||$a(b);this.assets=a.assets||{};this.attrs=a.attrs||$a(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
Pg.prototype.clone=function(){var a=new Pg,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==ya(c)?a[b]=$a(c):a[b]=c}return a};function Qg(){M.call(this);this.f=[]}
t(Qg,M);Qg.prototype.m=function(){for(;this.f.length;){var a=this.f.pop();a.target.removeEventListener(a.name,a.nb)}M.prototype.m.call(this)};var Rg=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function Sg(a){a=a||"";if(window.spf){var b=a.match(Rg);spf.style.load(a,b?b[1]:"",void 0)}else Tg(a)}
function Tg(a){var b=Ug(a),c=document.getElementById(b),d=c&&Ue(c,"loaded");d||c&&!d||(c=Vg(a,b,function(){Ue(c,"loaded")||(Se(c),cf(b),T(Ha(df,b),0))}))}
...
function Ug(a){var b=document.createElement("A");a=yb(a);Hb(b,a);b=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Mb(b)}
;function Wg(a,b){M.call(this);this.l=this.U=a;this.F=b;this.o=!1;this.api={};this.S=this.B=null;this.G=new O;Sc(this,Ha(Tc,this.G));this.i={};this.P=this.T=this.h=this.Z=this.f=null;this.K=!1;this.j=this.A=null;this.V={};this.qa=["onReady"];this.Y=null;this.ha=NaN;this.R={};Xg(this);this.W("WATCH_LATER_VIDEO_ADDED",this.Ka.bind(this));this.W("WATCH_LATER_VIDEO_REMOVED",this.La.bind(this));this.W("onAdAnnounce",this.sa.bind(this));this.ra=new Qg(this);Sc(this,Ha(Tc,this.ra))}
t(Wg,M);m=Wg.prototype;m.getId=function(){return this.F};
m.loadNewVideoConfig=function(a){if(!this.g){a instanceof Pg||(a=new Pg(a));this.Z=a;this.f=a.clone();this.h=this.f.attrs.id||this.h;"video-player"==this.h&&(this.h=this.F,this.f.attrs.id=this.F);this.l.id==this.h&&(this.h+="-player",this.f.attrs.id=this.h);this.f.args.enablejsapi="1";this.f.args.playerapiid=this.F;this.T||(this.T=Yg(this,this.f.args.jsapicallback||"onYouTubePlayerReady"));this.f.args.jsapicallback=null;if(a=this.f.attrs.width)this.l.style.width=tc(Number(a)||a);if(a=this.f.attrs.height)this.l.style.height=
tc(Number(a)||a);Zg(this);this.o&&$g(this)}};
...
function ah(a){var b=!0,c=bh(a);c&&a.f&&(a=a.f,b=Ue(c,"version")==a.assets.js);return b&&!!A("yt.player.Application.create")}
function Zg(a){if(!a.g&&!a.K){var b=ah(a);if(b&&"html5"==(bh(a)?"html5":null))a.P="html5",a.o||ch(a);else if(dh(a),a.P="html5",b&&a.j)a.U.appendChild(a.j),ch(a);else{a.f.loaded=!0;var c=!1;a.A=function(){c=!0;var d=a.f.clone();A("yt.player.Application.create")(a.U,d);ch(a)};
a.K=!0;b?a.A():(hf(a.f.assets.js,a.A),Sg(a.f.assets.css),eh(a)&&!c&&z("yt.player.Application.create",null,void 0))}}}
function bh(a){var b=$b(a.h);!b&&a.l&&a.l.querySelector&&(b=a.l.querySelector("#"+a.h));return b}
function ch(a){if(!a.g){var b=bh(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);c?(a.K=!1,b.isNotServable&&b.isNotServable(a.f.args.video_id)||fh(a)):a.ha=T(function(){ch(a)},50)}}
...
function gh(a,b,c){var d=b[c];return function(){try{return a.Y=null,d.apply(b,arguments)}catch(e){"sendAbandonmentPing"!=c&&(e.message+=" ("+c+")",a.Y=e,ee(e))}}}
function Xg(a){a.o=!1;if(a.S)for(var b in a.i)a.S(b,a.i[b]);for(var c in a.R)U(parseInt(c,10));a.R={};a.B=null;a.S=null;for(var d in a.api)a.api[d]=null;a.api.addEventListener=a.W.bind(a);a.api.removeEventListener=a.Pa.bind(a);a.api.destroy=a.dispose.bind(a);a.api.getLastError=a.wa.bind(a);a.api.getPlayerType=a.xa.bind(a);a.api.getCurrentVideoConfig=a.va.bind(a);a.api.loadNewVideoConfig=a.loadNewVideoConfig.bind(a);a.api.isReady=a.Ja.bind(a)}
m.Ja=function(){return this.o};
m.W=function(a,b){var c=this,d=Yg(this,b);if(d){if(!(0<=Ja(this.qa,a)||this.i[a])){var e=hh(this,a);this.B&&this.B(a,e)}this.G.subscribe(a,d);"onReady"==a&&this.o&&T(function(){d(c.api)},0)}};
m.Pa=function(a,b){if(!this.g){var c=Yg(this,b);c&&Ed(this.G,a,c)}};
function Yg(a,b){var c=b;if("string"==typeof b){if(a.V[b])return a.V[b];c=function(){var d=A(b);d&&d.apply(w,arguments)};
a.V[b]=c}return c?c:null}
function hh(a,b){var c="ytPlayer"+b+a.F;a.i[b]=c;w[c]=function(d){var e=T(function(){if(!a.g){a.G.L(b,d);var f=a.R,g=String(e);g in f&&delete f[g]}},0);
Ya(a.R,String(e))};
return c}
...
m.m=function(){dh(this);if(this.j&&this.f&&this.j.destroy)try{this.j.destroy()}catch(b){R(b)}this.V=null;for(var a in this.i)w[this.i[a]]=null;this.Z=this.f=this.api=null;delete this.U;delete this.l;M.prototype.m.call(this)};
function eh(a){return a.f&&a.f.args&&a.f.args.fflags?-1!=a.f.args.fflags.indexOf("player_destroy_old_version=true"):!1}
;var ih={},jh="player_uid_"+(1E9*Math.random()>>>0);function kh(a){var b="player";b=y(b)?$b(b):b;var c=jh+"_"+(b[Da]||(b[Da]=++Ea)),d=ih[c];if(d)return d.loadNewVideoConfig(a),d.api;d=new Wg(b,c);ih[c]=d;cf("player-added",d.api);Sc(d,Ha(lh,d));T(function(){d.loadNewVideoConfig(a)},0);
return d.api}
function lh(a){delete ih[a.getId()]}
;function mh(a,b,c){c=void 0===c?{}:c;var d=vg;Q("ytLoggingEventsDefaultDisabled",!1)&&vg==vg&&(d=null);qg(a,b,d,c)}
;var nh=A("ytLoggingLatencyUsageStats_")||{};z("ytLoggingLatencyUsageStats_",nh,void 0);var oh=0;function ph(a){nh[a]=nh[a]||{count:0};var b=nh[a];b.count++;b.time=Bf();oh||(oh=rf(qh,0,5E3));if(5<b.count){if(6==b.count&&1>1E5*Math.random()){b=0==a.indexOf("info")?"WARNING":"ERROR";var c=Error("CSI data exceeded logging limit with key");c.params=a;Pe(c,b)}return!0}return!1}
function qh(){var a=Bf(),b;for(b in nh)6E4<a-nh[b].time&&delete nh[b];oh=0}
...
xh.prototype.toString=function(){return this.topic};var yh=A("ytPubsub2Pubsub2Instance")||new O;O.prototype.subscribe=O.prototype.subscribe;O.prototype.unsubscribeByKey=O.prototype.M;O.prototype.publish=O.prototype.L;O.prototype.clear=O.prototype.clear;z("ytPubsub2Pubsub2Instance",yh,void 0);z("ytPubsub2Pubsub2SubscribedKeys",A("ytPubsub2Pubsub2SubscribedKeys")||{},void 0);z("ytPubsub2Pubsub2TopicToKeys",A("ytPubsub2Pubsub2TopicToKeys")||{},void 0);z("ytPubsub2Pubsub2IsAsync",A("ytPubsub2Pubsub2IsAsync")||{},void 0);
z("ytPubsub2Pubsub2SkipSubKey",null,void 0);function zh(a,b){var c=A("ytPubsub2Pubsub2Instance");c&&c.publish.call(c,a.toString(),a,b)}
...
function Bh(){var a=Ah(),b;for(b in a)tf(a[b]);P("TIMING_TICK_EXPIRATION",{})}
...
function Nh(){Oh().info.yt_lt="hot_bg";if(Ph()){var a="hot_bg",b=Qh();(b.gelInfos?b.gelInfos:b).info_yt_lt=!0;if("yt_lt"in Hh){var c=Hh.yt_lt;0<=Ja(Jh,c)&&(a=!!a);"yt_lt"in Lh&&(a=Lh.yt_lt+a.toUpperCase());b={};c=c.split(".");for(var d=b,e=0;e<c.length-1;e++)d[c[e]]=d[c[e]]||{},d=d[c[e]];d[c[c.length-1]]=a;Ph()&&(a=Oh(),"gelInfo"in a||(a.gelInfo={}),rh(a.gelInfo,b),a=Rh(),c=Object.keys(b).join(""),ph("info_"+c+"_"+a)||(b.clientActionNonce=a,mh("latencyActionInfo",b)))}else 0<=Ja(Ih,"yt_lt")||(b=Error("Unknown label logged with GEL CSI"),
b.params="yt_lt",ee(b))}}
...
B(X.clearResourceTimings||X.webkitClearResourceTimings||X.mozClearResourceTimings||X.msClearResourceTimings||X.oClearResourceTimings||wa,X);function Rh(){var a=Oh().nonce;a||(a=Gg(),Oh().nonce=a);return a}
function Th(){return Oh().tick}
function Qh(){var a=Oh();"gel"in a||(a.gel={});return a.gel}
function Oh(){var a;(a=A("ytcsi.data_"))||(a={tick:{},info:{}},Ia("ytcsi.data_",a));return a}
function Uh(){var a=Th(),b=a.pbr,c=a.vc;a=a.pbs;return b&&c&&a&&b<c&&c<a&&1==Oh().info.yt_pvis}
function Ph(){return!!S("csi_on_gel")||!!Oh().useGel}
function Vh(){Bh();if(!Ph()){var a=Th(),b=Oh().info,c=a._start;for(f in a)if(0==f.lastIndexOf("_",0)&&za(a[f])){var d=f.slice(1);if(d in Gh){var e=La(a[f],function(l){return Math.round(l-c)});
b["all_"+d]=e.join()}delete a[f]}e=Q("CSI_SERVICE_NAME","youtube");var f={v:2,s:e,action:Q("TIMING_ACTION",void 0)};d=Nh.srt;void 0!==a.srt&&delete b.srt;if(b.h5jse){var g=window.location.protocol+A("ytplayer.config.assets.js");(g=X.getEntriesByName?X.getEntriesByName(g)[0]:null)?b.h5jse=Math.round(b.h5jse-g.responseEnd):delete b.h5jse}a.aft=Sh();Uh()&&"youtube"==e&&(Nh(),e=a.vc,g=a.pbs,delete a.aft,b.aft=Math.round(g-e));for(var h in b)"_"!=h.charAt(0)&&(f[h]=b[h]);a.ps=Sf();h={};e=[];for(var k in a)"_"!=
k.charAt(0)&&(g=Math.round(a[k]-c),h[k]=g,e.push(k+"."+g));f.rt=e.join(",");(a=A("ytdebug.logTiming"))&&a(f,h);Wh(f,!!b.ap);zh(Fh,new Dh(h.aft+(d||0),void 0))}}
...
function Yh(a,b,c){y(a)&&(a={mediaContentUrl:a,startSeconds:b,suggestedQuality:c});b=/\/([ve]|embed)\/([^#?]+)/.exec(a.mediaContentUrl);a.videoId=b&&b[2]?b[2]:null;return Zh(a)}
function Zh(a,b,c){if(Ca(a)){b=["endSeconds","startSeconds","mediaContentUrl","suggestedQuality","videoId"];c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}return{videoId:a,startSeconds:b,suggestedQuality:c}}
function $h(a,b,c,d){if(Ca(a)&&!za(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};y(a)&&16==a.length?b.list="PL"+a:b.playlist=a;return b}
;function ai(a){M.call(this);this.f=a;this.f.subscribe("command",this.ma,this);this.h={};this.j=!1}
E(ai,M);m=ai.prototype;m.start=function(){this.j||this.g||(this.j=!0,bi(this.f,"RECEIVING"))};
...
m.m=function(){var a=this.f;a.g||Ed(a.f,"command",this.ma,this);this.f=null;for(var b in this.h)ci(this,b);ai.C.m.call(this)};function fi(a,b){ai.call(this,b);this.i=a;this.start()}
E(fi,ai);fi.prototype.addEventListener=function(a,b){this.i.addEventListener(a,b)};
...
t(gi,M);gi.prototype.sendMessage=function(a,b){var c=b||this.h;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=JSON.stringify(a);c.postMessage(d,this.A)}catch(e){R(e,"WARNING")}}};
gi.prototype.m=function(){window.removeEventListener("message",this.o);M.prototype.m.call(this)};function hi(){var a=this.g=new gi(!!Q("WIDGET_ID_ENFORCE")),b=B(this.Oa,this);a.j=b;a.l=null;this.g.channel="widget";if(a=Q("WIDGET_ID"))this.g.sessionId=a;this.i=[];this.l=!1;this.j={}}
...
this))}
E(ki,hi);m=ki.prototype;m.oa=function(a,b,c){if(this.f.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&Xh(a)){var d=b;if(Ca(d[0])&&!za(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=Zh.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=Yh.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=$h.apply(window,d)}d=e}b.length=1;b[0]=d}this.f.handleExternalCall(a,b,c);Xh(a)&&ji(this,this.da())}};
...
m.Va=function(a){a={currentTime:a,videoBytesLoaded:this.f.getVideoBytesLoaded(),videoLoadedFraction:this.f.getVideoLoadedFraction(),currentTimeLastUpdated_:D()/1E3,playbackRate:this.f.getPlaybackRate(),mediaReferenceTime:this.f.getMediaReferenceTime()};this.f.getProgressState&&(a.progressState=this.f.getProgressState());ji(this,a)};
m.Xa=function(){var a={sphericalProperties:this.f.getSphericalProperties()};ji(this,a)};
m.dispose=function(){ki.C.dispose.call(this);for(var a=0;a<this.h.length;a++){var b=this.h[a];this.f.removeEventListener(b.eventType,b.listener)}this.h=[]};function li(a){a=void 0===a?!1:a;M.call(this);this.f=new O(a);Sc(this,Ha(Tc,this.f))}
E(li,M);li.prototype.subscribe=function(a,b,c){return this.g?0:this.f.subscribe(a,b,c)};
...
E(mi,li);function bi(a,b,c){if(!a.g){var d=a.h;d.g||a.i!=d.f||(a={id:a.l,command:b},c&&(a.data=c),d.f.postMessage(gd(a),d.i))}}
mi.prototype.m=function(){this.i=this.h=null;mi.C.m.call(this)};function ni(a,b,c){M.call(this);this.f=a;this.i=c;this.j=V(window,"message",B(this.l,this));this.h=new mi(this,a,b);Sc(this,Ha(Tc,this.h))}
E(ni,M);ni.prototype.l=function(a){var b;if(b=!this.g)if(b=a.origin==this.i)a:{b=this.f;do{b:{var c=a.source;do{if(c==b){c=!0;break b}if(c==c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(b=a.data,y(b))){try{b=JSON.parse(b)}catch(d){return}b.command&&(c=this.h,c.g||c.j("command",b.command,b.data,a.origin))}};
ni.prototype.m=function(){Rf(this.j);this.f=null;ni.C.m.call(this)};function oi(){var a=$a(pi),b;return td(new N(function(c,d){a.onSuccess=function(e){qe(e)?c(e):d(new qi("Request failed, status="+e.status,"net.badstatus",e))};
...
return rd(c)})}
function qi(a,b){G.call(this,a+", errorCode="+b);this.errorCode=b;this.name="PromiseAjaxError"}
t(qi,G);function ri(){this.g=0;this.f=null}
ri.prototype.then=function(a,b,c){return 1===this.g&&a?(a=a.call(c,this.f),md(a)?a:si(a)):2===this.g&&b?(a=b.call(c,this.f),md(a)?a:ti(a)):this};
...
;function ui(a){G.call(this,a.message||a.description||a.name);this.isMissing=a instanceof vi;this.isTimeout=a instanceof qi&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof ud}
t(ui,G);ui.prototype.name="BiscottiError";function vi(){G.call(this,"Biscotti ID is missing from server")}
t(vi,G);vi.prototype.name="BiscottiMissingError";var pi={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},wi=null;function be(){if("1"===Ua($d(),"args","privembed"))return rd(Error("Biscotti ID is not available in private embed mode"));wi||(wi=td(oi().then(xi),function(a){return yi(2,a)}));
return wi}
function xi(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new vi;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new vi;a=a.id;ce(a);wi=si(a);zi(18E5,2);return a}
function yi(a,b){var c=new ui(b);ce("");wi=ti(c);0<a&&zi(12E4,a-1);throw c;}
function zi(a,b){T(function(){td(oi().then(xi,function(c){return yi(b,c)}),wa)},a)}
function Ai(){try{var a=A("yt.ads.biscotti.getId_");return a?a():be()}catch(b){return rd(b)}}
;function Bi(a){if("1"!==Ua($d(),"args","privembed")){a&&ae();try{Ai().then(function(b){S("pass_biscotti_id_in_header_ajax_tv")||S("pass_biscotti_id_in_header_ajax")||(b=je(b),b.bsq=Ci++,Ge("//www.youtube.com/ad_data_204",{ya:!1,D:b,withCredentials:!0}))},function(){}),T(Bi,18E5)}catch(b){R(b)}}}
var Ci=0;var Z=A("ytglobal.prefsUserPrefsPrefs_")||{};z("ytglobal.prefsUserPrefsPrefs_",Z,void 0);function Di(){this.f=Q("ALT_PREF_COOKIE_NAME","PREF");var a=Ub.get(""+this.f,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Z[d]=c.toString())}}}
...
xa(Di);var Hi=null,Ii=null,Ji=null,Ki={};function Li(a){var b=a.id;a=a.ve_type;var c=tg++;a=new rg({veType:a,veCounter:c,elementIndex:void 0,dataElement:void 0,youtubeData:void 0});Ki[b]=a;b=Mg();c=Lg();b&&c&&ug(b,c,[a])}
...
;z("yt.setConfig",P,void 0);z("yt.config.set",P,void 0);z("yt.setMsg",Re,void 0);z("yt.msgs.set",Re,void 0);z("yt.logging.errors.log",Pe,void 0);
...
Pi);b=Q("POST_MESSAGE_ID","player");Q("ENABLE_JS_API")?Ji=new ki(a):Q("ENABLE_POST_API")&&y(b)&&y(c)&&(Ii=new ni(window.parent,b,c),Ji=new fi(a,Ii.h));c=Zd("BG_P");Hf(c)&&(Q("BG_I")||Q("BG_IU"))&&(Df=!0,Cf.initialize(Q("BG_I",null),Q("BG_IU",null),c,Gf,void 0));wf()},void 0);
z("yt.www.watch.ads.restrictioncookie.spr",function(a){Je(a+"mac_204?action_fcts=1");return!0},void 0);
var Qi=de(function(){var a="ol";X.mark&&(0==a.lastIndexOf("mark_",0)||(a="mark_"+a),X.mark(a));a=Th();var b=Sf();a.ol&&(a._ol=a._ol||[a.ol],a._ol.push(b));a.ol=b;a=Ah();if(b=a.ol)tf(b),a.ol=0;a=Qh();(a.gelTicks?a.gelTicks:a).tick_ol=!0;Sf();Ph()?(a=Rh(),ph("tick_ol_"+a)||mh("latencyActionTicked",{tickName:"ol",clientActionNonce:a},{timestamp:void 0}),a=!0):a=!1;if(a=!a)a=!A("yt.timing.pingSent_");if(a&&(b=Q("TIMING_ACTION",void 0),a=Th(),A("ytglobal.timingready_")&&b&&a._start&&(b=Sh()))){Mh||(zh(Eh,
new Ch(Math.round(b-a._start),void 0)),Mh=!0);b=!0;var c=Q("TIMING_WAIT",[]);if(c.length)for(var d=0,e=c.length;d<e;++d)if(!(c[d]in a)){b=!1;break}b&&Vh()}a=Di.getInstance();c=!!((Gi("f"+(Math.floor(119/31)+1))||0)&67108864);b=1<window.devicePixelRatio;document.body&&Wc(document.body,"exp-invert-logo")&&(b&&!Wc(document.body,"inverted-hdpi")?(d=document.body,d.classList?d.classList.add("inverted-hdpi"):Wc(d,"inverted-hdpi")||(d.className+=0<d.className.length?" inverted-hdpi":"inverted-hdpi")):!b&&
Wc(document.body,"inverted-hdpi")&&Xc());c!=b&&(c="f"+(Math.floor(119/31)+1),d=Gi(c)||0,d=b?d|67108864:d&-67108865,0==d?delete Z[c]:(b=d.toString(16),Z[c]=b.toString()),a.save())}),Ri=de(function(){var a=Hi;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();Q("PL_ATT")&&Cf.dispose();a=0;for(var b=uf.length;a<b;a++)tf(uf[a]);uf.length=0;nf("//static.doubleclick.net/instream/ad_status.js");vf=!1;P("DCLKSTAT",0);Uc(Ji,Ii);if(a=Hi)a.removeEventListener("onScreenChanged",Mi),a.removeEventListener("onLogClientVeCreated",Li),a.removeEventListener("onLogServerVeCreated",Ni),a.removeEventListener("onLogVeClicked",Oi),a.removeEventListener("onLogVesShown",Pi),a.destroy();Ki={}});
window.addEventListener?(window.addEventListener("load",Qi),window.addEventListener("unload",Ri)):window.attachEvent&&(window.attachEvent("onload",Qi),window.attachEvent("onunload",Ri));Ia("yt.abuse.player.botguardInitialized",A("yt.abuse.player.botguardInitialized")||If);Ia("yt.abuse.player.invokeBotguard",A("yt.abuse.player.invokeBotguard")||Jf);Ia("yt.abuse.dclkstatus.checkDclkStatus",A("yt.abuse.dclkstatus.checkDclkStatus")||xf);
Ia("yt.player.exports.navigate",A("yt.player.exports.navigate")||Og);Ia("yt.util.activity.init",A("yt.util.activity.init")||Vf);Ia("yt.util.activity.getTimeSinceActive",A("yt.util.activity.getTimeSinceActive")||Yf);Ia("yt.util.activity.setTimestamp",A("yt.util.activity.setTimestamp")||Wf);}).call(this);
